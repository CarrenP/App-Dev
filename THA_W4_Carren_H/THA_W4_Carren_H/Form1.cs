...
namespace THA_W4_Carren_H
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            player player1_3 = new player("Thibaut Courtois", "01", "GK");
            team3.players.Add(player1_3);
            player player2_3 = new player("Daniel Carvajal Ramos", "02", "DF");
            team3.players.Add(player2_3);
            player player3_3 = new player("Eder Gabriel Militao", "03", "DF");
            team3.players.Add(player3_3);
            player player4_3 = new player("David Alaba", "04", "DF");
            team3.players.Add(player4_3);
            player player5_3 = new player("Jesus Vallejo Lazaro", "05", "DF");
            team3.players.Add(player5_3);
            player player6_3 = new player("Jose I.Fernandez Iglesias", "06", "DF");
            team3.players.Add(player6_3);
            player player7_3 = new player("Eden Hazard", "07", "Fw");
            team3.players.Add(player7_3);
            player player8_3 = new player("Toni Kroos", "08", "MDF");
            team3.players.Add(player8_3);
            player player9_3 = new player("Karim Benzema", "09", "FW");
            team3.players.Add(player9_3);
            player player10_3 = new player("Luka Modric", "10", "MDF");
            team3.players.Add(player10_3);
            player player11_3 = new player("Marco Asensio Willemsen", "11", "FW");
        ...
        private void button_addteam_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (comboBox_team.Items.Contains(a.teamName))
                    {
